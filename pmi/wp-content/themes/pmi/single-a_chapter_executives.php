...
<div class="pmi_welcome">
		...
		<?php	  global $wpdb;
        echo"<p>". $a_executives_designation = get_post_meta( $post->ID, 'a_executives_designation', true );
		echo"<p>".$a_executives_email = get_post_meta( $post->ID, 'a_executives_email', true );
		echo"<p>". $a_executives_mobile = get_post_meta( $post->ID, 'a_executives_mobile', true );?></a></div>
