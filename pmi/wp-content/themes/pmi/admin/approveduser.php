<?php
add_option('app_table_example_db_version', $voix_table_example_db_version);
add_action('plugins_loaded', 'app_table_example_update_db_check');

function app_table_example_update_db_check()
{
    global $app_table_example_db_version;
	
    if (get_site_option('app_table_example_db_version') != $voix_table_example_db_version) {
...
class App_Table_Example_List_Table extends WP_List_Table
{
...
function app_table_example_admin_menu()
{
    add_menu_page(__('Approved User', 'app_table_example'), __('Approved User', 'app_table_example'), 'activate_plugins', 'approves', 'app_table_example_persons_page_handler');
...
add_action('admin_menu', 'app_table_example_admin_menu');

function app_table_example_persons_page_handler()
{
    global $wpdb;
    ...
    $table = new App_Table_Example_List_Table();
    $table->prepare_items();
/*
    $message = '';
