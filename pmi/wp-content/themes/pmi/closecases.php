<?php
/*
Template Name: Close Cases Template
*/
?>
<?php get_header();?>
...
<div class="main_bg_shadow">
  <div class="pmichennai_tab">
    <div class="col-xs-12 col-md-8 col-sm-8 col-lg-8">
      <div class="pmi_welcome"> <h4>Closed Cases </h4>
        <div class="help_disk">
		...
		<?php 
		  ...
		  $username = $current_user->user_email;
			 $user_query =  "SELECT * FROM helpdisk WHERE help_mail = '".$username."' AND  status= 'close' ";
		  ...
		  ?>
			  ...
			  {
				  echo "Sorry, You don't have any closed Help Desk ticket";
			  }?>
