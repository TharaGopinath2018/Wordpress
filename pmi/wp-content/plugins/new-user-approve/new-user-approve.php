...
class pw_new_user_approve {
	...
	public function approve_user( $user_id ) {
		...
		//$message .= 'You have been approved to access PMIChennai.org with the username given below';

		$subject = sprintf( __( 'Your Registration at PMIChennai.org is Approved', 'new-user-approve' ), get_option( 'blogname' ) );
	...
	public function email_message_headers() {
		$admin_email = "website@pmi-chennai.org";
		//$admin_email = get_option( 'admin_email' );koushik.s@pmi-chennai.org 
		if ( empty( $admin_email ) ) {
			$admin_email = 'support@' . $_SERVER['SERVER_NAME'];
		}

		//$from_name = get_option( 'blogname' );
		$from_name = "PMI Chennai Chapter";
